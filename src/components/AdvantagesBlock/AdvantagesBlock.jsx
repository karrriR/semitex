...
function AdvantagesBlock() {
    const advantages = [
        {
            logo: `${process.env.PUBLIC_URL}/images/icons/advantages-icon/quality-products-icon.png`,
            title: "Качественная продукция",
            description: "Все наши товары сертифицированы и имеют сопроводительную документацию.",
        },
        {
            logo: `${process.env.PUBLIC_URL}/images/icons/advantages-icon/individual-approach-icon.png`,
            title: "Индивидуальный подход",
            description: "Возможность изготовления компонентов специально для вас на заводах-изготовителя.",
        },
        {
            logo: `${process.env.PUBLIC_URL}/images/icons/advantages-icon/free-shipping-icon.png`,
        ...
        {
            logo: `${process.env.PUBLIC_URL}/images/icons/advantages-icon/analogues-icon.png`,
            title: "Подбираем аналоги",
            description: "Поможем подобрать аналоги популярных европейских брендов в условиях санкций.",
        },
        {
            logo: `${process.env.PUBLIC_URL}/images/icons/advantages-icon/spare-parts-icon.png`,
            title: "Резервный запас компонентов",
            description: "Хранение товара на наших складах для постоянных клиентов.",
        },
        {
            logo: `${process.env.PUBLIC_URL}/images/icons/advantages-icon/flexible-system-icon.png`,
